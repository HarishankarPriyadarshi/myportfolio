...
export const Bio = {
  ...
  insta: "https://www.instagram.com/who_i_am_423_/",
  facebook: "https://www.facebook.com/profile.php?id=100024214697813",
};
...
export const skills = [
  {
    ...
    skills: [
      ...
      },
      {
        name: "Angular",
        image:
          "https://w7.pngwing.com/pngs/752/651/png-transparent-angularjs-vue-js-others-angle-rectangle-triangle.png",
      }
...
export const experiences = [
  ...
  {
    id: 1,
    img: 'https://www.vlab.co.in/images/logo.jpg',
    role: "Project Associate",
    company: "Virtual Labs IIT Roorkee",
    date: "May 2025 - Present",
    desc: "Currently working as a Project Associate at the Electrical Engineering Department, IIT Roorkee, under the Ministry of Education’s Virtual Lab project. I have been actively involved in the design and development of dynamic web-based tools for educational and administrative workflows. My contributions include building a billing software system with file uploads, automated calculations, and PDF generation; enhancing an existing laboratory platform through audio-video integration for virtual experiment delivery; and contributing to the development of a Biomedical Signal Processing Lab using modern fullstack technologies. The work involves Angular, Node.js, MySQL, and tools like GSAP and Framer Motion to deliver smooth, interactive user experiences.",
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
